...
<div class="fb-like" data-href="http://www.irrimaker.com/layout-calc/" data-send="false" data-width="50" data-show-faces="false"></div>
...
<input type="text"  value="6" name="number_heads" />
</li>
<li>
<label for=email>Head Space</label>
<input type="text"  value="20" name="spacing_heads" /><i id="spacing_heads_units"></i>
</li>
<li>
<label for=phone># of Rows</label>
<input type="text"  value="6" name="number_rows" />
</li>
<li>
<label for=phone>Row Space</label>
<input type="text"  value="20" name="spacing_rows" /><i id="spacing_rows_units"></i>
</li>
</ol>
</fieldset>
...
<canvas id="canvas" width="550" height="550" style="float:left; background:#ggg; border:0px dashed #ccc; margin:0px;"></canvas>





<div class="fb-comments" style="margin:25px;" data-href="http://www.irrimaker.com/layout-calc" data-num-posts="2" data-width="500"></div>
